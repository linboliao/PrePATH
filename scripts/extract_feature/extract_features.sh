...
batch_size=32
patch_size=448
wsi_dir=/NAS2/Data1/lbliao/Data/MXB/classification/100例测试 # The directory where the WSI files are stored
feat_dir=/NAS2/Data1/lbliao/Data/MXB/classification/100例测试/feat_0_$patch_size # path to save feature
coors_dir=/NAS2/Data1/lbliao/Data/MXB/classification/100例测试/patches_0_$patch_size # path where the coors files are saved
