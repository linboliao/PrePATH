...
CUDA_VISIBLE_DEVICES=2 python extract_features_fp_stains_separate.py --data_coors_dir $coord_dir --data_slide_dir $wsi_dir --slide_ext $slide_ext --csv_path $csv_path/part_2.csv --feat_dir $feat_dir